...
const BANKING_AUDIT_MAP: Record<BankingAuditAction, AuditAction> = {
  "banking.connection.created": "banking.connection.changed",
  "banking.connection.disconnected": "banking.connection.changed",
  "banking.sync.started": "settings.updated",
  "banking.sync.completed": "settings.updated",
  "banking.sync.failed": "banking.sync.failed",
  ...
  "banking.match.suggested": "banking.match.suggested",
  "banking.match.confirmed": "banking.match.confirmed",
  "banking.match.removed": "banking.match.removed",
