...
function runOnce(label) {
  const result = spawnSync("npx", ["tsx", "scripts/controlled-phase17b-security-acceptance.ts"], {
    stdio: "inherit",
    env: process.env,
  });
...
runOnce("PHASE17B_ACCEPTANCE_RERUN_1");
if (rerun) runOnce("PHASE17B_ACCEPTANCE_RERUN_2");

console.log(
  JSON.stringify(
    {
      PHASE17B_ACCEPTANCE_RERUN_1: "PASS",
      PHASE17B_ACCEPTANCE_RERUN_2: rerun ? "PASS" : "SKIPPED",
    },
    null,
    2,
  ),
