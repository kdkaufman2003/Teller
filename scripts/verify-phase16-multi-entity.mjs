  ...
  JSON.stringify(
    {
      ...
      intercompanyImplemented: existsSync(join(root, "supabase/migrations/044_phase16d_intercompany.sql")),
      phase16dPrepared: existsSync(join(root, "supabase/migrations/044_phase16d_intercompany.sql")),
      phase16ePrepared: existsSync(join(root, "supabase/migrations/045_phase16e_intercompany_settlement.sql")),
      hfacModified: false,
    },
    null,
    2,
