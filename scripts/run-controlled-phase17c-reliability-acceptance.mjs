...
function runOnce(label) {
  const result = spawnSync("npx", ["tsx", "scripts/controlled-phase17c-reliability-acceptance.ts"], {
    stdio: "inherit",
    env: process.env,
  });
...
runOnce("PHASE17C_ACCEPTANCE_RERUN_1");
if (rerun) runOnce("PHASE17C_ACCEPTANCE_RERUN_2");

console.log(
  JSON.stringify(
    {
      PHASE17C_ACCEPTANCE_RERUN_1: "PASS",
      PHASE17C_ACCEPTANCE_RERUN_2: rerun ? "PASS" : "SKIPPED",
    },
    null,
    2,
  ),
