...
| `PHASE_15_COMPLETE` | **true** | Deploy `71942a4` → `https://teller-indol.vercel.app`; 111/111 acceptance; HFAC 8 docs / 17 journals unchanged |
...
| `PHASE_16D_DB_VERIFIED` | **true** | Migration 044 applied; 19/19 acceptance × 2 reruns |
| `PHASE_16D_COMPLETE` | **true** | 0 unbalanced production journals; HFAC 17 journals unchanged |
| `MANUAL_PATCH_044_PROVISION_APPLIED` | **true** | `supabase/patches/044_phase16d_provision_pair_lookup_fix.sql` (2026-09-12) |
| `PHASE_16E_STARTED` | **true** | Settlement + reconciliation layer on 16D |
| `PHASE_16E_CODE_COMPLETE` | **true** | Migration 045, settlement RPCs, UI, API, acceptance harness |
...
| `PHASE_16G_STARTED` | **true** | Consolidation elimination layer on 16F reporting |
| `PHASE_16G_CODE_COMPLETE` | **true** | Migration 046 prepared, elimination lib/API/UI, worksheet, static verify |
| `PHASE_16G_DB_VERIFIED` | **true** | Migration 046 applied manually; 17/17 controlled acceptance PASS |
